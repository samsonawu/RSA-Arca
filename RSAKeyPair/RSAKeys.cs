...
namespace RSAKeyPair
{
    public class RSAKeys
    {
        ...
        /// <returns></returns>
        public RSACryptoServiceProvider ImportPrivateKey(AsymmetricCipherKeyPair privateKey)
        {
            RSAParameters rsaParams = DotNetUtilities.ToRSAParameters((RsaPrivateCrtKeyParameters)privateKey.Private);
        ...
        /// <param name="pem"></param>
        /// <returns></returns>
        public RSACryptoServiceProvider ImportPublicKey(AsymmetricCipherKeyPair publicKey)
        {
        ...
        public string RsaDecryptWithPrivate(string base64Input, AsymmetricCipherKeyPair keyPair)
        {
            ...
            var decrypted =  HexEncoding.ToString(decryptEngine.ProcessBlock(bytesToDecrypt, 0, bytesToDecrypt.Length));
            return decrypted;
        }
        ...
        public class HmacSha256WithKeyResponse
        {
